          ...
          <div className="relative z-10 w-full flex flex-col items-center bg-transparent">
            ...
            <section className="relative py-24 md:py-32 w-full flex flex-col items-center justify-center z-20 bg-[#faf9f8]">
              ...
              <div className="relative z-10 w-full px-6 text-center">
                ...
                <p className="font-headline text-2xl md:text-3xl text-slate-500 tracking-wide mb-10 italic font-bold">
                  SOL Theory
                </p>

                {/* Main Headline */}
                <h2 className="font-jakarta text-4xl md:text-[3.4rem] font-bold text-slate-800 tracking-tight leading-[1.15] max-w-3xl mx-auto">
                ...
                {/* Subtitle */}
                <p className="mt-5 text-slate-500 text-base md:text-lg font-light max-w-xl mx-auto">
