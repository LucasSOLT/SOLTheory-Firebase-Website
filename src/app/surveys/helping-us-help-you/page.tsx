...
function HelpingUsHelpYouForm() {
  ...
  const onSubmit = (data: SurveyFormValues) => {
    ...
    toast({
      ...
      description: 'Thank you for your valuable feedback. Your responses have been saved.',
    });
    setIsSubmitted(true);
  }
          ...
          <CardContent>
            <Form {...form}>
              <form ref={formRef} onSubmit={form.handleSubmit(onSubmit, onError)} className="space-y-12">
                      ...
                      <CardContent className="space-y-8">
                           ...
                           <FormField control={form.control} name="selfContext" render={({ field }) => (
                              <FormItem>
                                ...
                                <FormControl><Textarea placeholder="e.g., I'm new to the team, I'm responsible for X..." {...field} /></FormControl>
                                <FormDescription className="text-sm italic">Skip if you are unsure.</FormDescription>
                                <FormMessage />
                              </FormItem>
                           )} />
                      ...
                      <div className="space-y-8">
                        <FormField control={form.control} name="copyPasteTest" render={({ field }) => (
                            <FormItem className="space-y-3 p-4 rounded-lg bg-background/50 form-item-container">
                              ...
                              <FormControl><div className="radio-group-container"><RadioGroup onValueChange={field.onChange} value={field.value} className="flex flex-col space-y-2 pt-2">
                                  ...
                                  <FormItem className="flex items-center space-x-3 space-y-0"><FormControl><RadioGroupItem value="Non-applicable/I don't know" /></FormControl><FormLabel className="font-normal text-lg text-muted-foreground">Non-applicable/I don't know</FormLabel></FormItem>
                        ...
                        <FormField control={form.control} name="copyPasteOffenders" render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl><Textarea placeholder="Tell us more..." {...field} className="bg-background/50"/></FormControl>
                              <FormDescription className="text-sm italic pl-4">Skip if you are unsure.</FormDescription>
                              <FormMessage />
                            </FormItem>
                        )} />
                        <FormField control={form.control} name="treasureHunt" render={({ field }) => (
                            <FormItem className="space-y-3 p-4 rounded-lg bg-background/50 form-item-container">
                              <FormLabel className="text-xl text-foreground">2. The "Treasure Hunt" 🗺️: When you need to find a specific piece of information (e.g., "Did a client attend a class last Tuesday?"), how long does it usually take you?</FormLabel>
                              <FormControl><div className="radio-group-container"><RadioGroup onValueChange={field.onChange} value={field.value} className="flex flex-col space-y-2 pt-2">
                        ...
                        <FormField control={form.control} name="reminderTreadmill" render={({ field }) => (
                            <FormItem className="space-y-3 p-4 rounded-lg bg-background/50 form-item-container">
                              <FormLabel className="text-xl text-foreground">3. The "Reminder" Treadmill 🏃‍♀️: How much of your week is spent sending/awaiting responses on routine text messages or emails to clients just to remind them of appointments, class times, or document deadlines?</FormLabel>
                              <FormControl><div className="radio-group-container"><RadioGroup onValueChange={field.onChange} value={field.value} className="flex flex-col space-y-2 pt-2">
                    ...
                    <div>
                      ...
                      <div className="space-y-8">
                        <FormField control={form.control} name="signatureChase" render={({ field }) => (
                            <FormItem className="space-y-3 p-4 rounded-lg bg-background/50 form-item-container">
                              <FormLabel className="text-xl text-foreground">4. The "Signature" Chase ✍️: How often does a client’s progress stop because you are waiting for a specific approval, signature, or document from someone else (a manager, a partner agency, etc.)?</FormLabel>
                              <FormControl><div className="radio-group-container"><RadioGroup onValueChange={field.onChange} value={field.value} className="flex flex-col space-y-2 pt-2">
                        ...
                        <FormField control={form.control} name="signatureChaseWho" render={({ field }) => (
                            <FormItem>
                              ...
                              <FormControl><Input placeholder="e.g., Manager, Partner Agency X" {...field} className="bg-background/50" /></FormControl>
                              <FormDescription className="text-sm italic pl-4">Skip if you are unsure.</FormDescription>
                              <FormMessage />
                            </FormItem>
                        )} />
                        <FormField control={form.control} name="didntKnowProblem" render={({ field }) => (
                            <FormItem className="space-y-3 p-4 rounded-lg bg-background/50 form-item-container">
                              <FormLabel className="text-xl text-foreground">5. The "I Didn't Know" Problem 🤷‍♀️: Have you ever walked into a meeting with a client or donor and felt unprepared because you didn't have the latest notes or history on them?</FormLabel>
                              <FormControl><div className="radio-group-container"><RadioGroup onValueChange={field.onChange} value={field.value} className="flex flex-col space-y-2 pt-2">
                      ...
                      <div className="space-y-8">
                        ...
                        <FormField control={form.control} name="workaround" render={({ field }) => (
                            <FormItem className="p-4 rounded-lg bg-background/50">
                              ...
                              <FormControl><Textarea placeholder="Please describe..." {...field} className="bg-background/80 mt-2"/></FormControl>
                      ...
                      <div className="space-y-8">
                        <FormField control={form.control} name="magicWand" render={({ field }) => (
                            <FormItem className="p-4 rounded-lg bg-background/50">
                              ...
                              <FormControl><Textarea placeholder="Describe the task..." {...field} className="bg-background/80 mt-2"/></FormControl>
                              <FormDescription className="text-sm italic mt-1">Skip if you are unsure.</FormDescription>
                              <FormMessage />
                            </FormItem>
                        )} />
                        ...
                        <FormField control={form.control} name="missionMultiplierOther" render={({ field }) => (
                            <FormItem>
                              <FormControl><Input placeholder="If other, please specify" {...field} className="bg-background/50" /></FormControl>
                              <FormDescription className="text-sm italic">Skip if you are unsure.</FormDescription>
                              <FormMessage />
                            </FormItem>
                        )} />
                        <FormField control={form.control} name="clientJourney" render={({ field }) => (
                            <FormItem className="p-4 rounded-lg bg-background/50">
                              ...
                              <FormControl><Textarea placeholder="Describe the challenges..." {...field} className="bg-background/80 mt-2"/></FormControl>
                              <FormDescription className="text-sm italic mt-1">Skip if you are unsure.</FormDescription>
                              <FormMessage />
                            </FormItem>
                        )} />
                        <FormField control={form.control} name="finalThoughts" render={({ field }) => (
                            <FormItem className="p-4 rounded-lg bg-background/50">
                              ...
                              <FormControl><Textarea placeholder="Your feedback is valuable..." {...field} className="bg-background/80 mt-2" /></FormControl>
                              <FormDescription className="text-sm italic mt-1">Skip if you are unsure.</FormDescription>
                              <FormMessage />
                            </FormItem>
                        )} />
                ...
                <Button type="submit" size="lg" className="w-full h-12 text-lg" disabled={isSubmitted || form.formState.isSubmitting}>
