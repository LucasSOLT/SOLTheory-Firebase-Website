                  ...
                  <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
                    {usersList
                      ...
                      .map((u) => {
                        ...
                        const userRoleColors = isDevAccount ? DEVELOPER_COLORS : (ROLE_COLORS[u.orgRoles?.[orgId] as keyof typeof ROLE_COLORS] || ROLE_COLORS["read-only"]);
                        const roleLabel = isDevAccount ? "Developer" : (ROLE_LABELS[u.orgRoles?.[orgId] as keyof typeof ROLE_LABELS] || "None");
                            ...
                            <td className="p-4">
                              <div className="relative group inline-block">
                                <select 
                                  ...
                                  value={isDevAccount ? "developer" : (u.orgRoles?.[orgId] || "read-only")}
                                  onChange={(e) => handleUpdateUserRole(u.uid, orgId, e.target.value)}
