...
export default function CommunicationsPage() {
  ...
  const INBOUND_STREAM: EmailItem[] = [
    ...
    { sender: `support@${orgId}.org`, subject: "Server Ticket #4419", preview: "The dashboard is routing correctly, but we...", time: "9:15 AM", status: "processing" },
    { sender: `admin@${orgId}.com`, subject: "AI Model Performance Report", preview: "Attached is the weekly generative metrics...", time: "Yesterday", status: "read" },
  ...
  const OUTBOUND_DRAFTS = [
    { text: `Drafting response to admin@${orgId}.com regarding AI performance...`, aiConfidence: 98, time: "Yesterday", isSelf: false },
    { text: "Approved. Sent report via PDF.", aiConfidence: 100, time: "Yesterday", isSelf: true },
    { text: `Analyzing Ticket #4419 from ${orgId}.org...`, aiConfidence: 95, time: "9:16 AM", isSelf: false },
  ];
