...
export default function NxtChapterDashboard() {
  ...
  useEffect(() => {
    ...
    const q = query(collection(firestore, "users"), where("currentDashboard", "==", "nxtchapter"));
  ...
  return (
    <div className="w-full max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700 h-full overflow-y-auto pb-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Link href="/portal/dashboard/nxtchapter/ai-agents/jarvis" className="block relative group h-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <MonthlyUsersChart data={monthlyData} accentColor="indigo" />
      </div>
    </div>
  );
}
