  ...
  return (
    <div className="min-h-screen bg-white px-8 py-16 max-w-3xl mx-auto">
      ...
      <div className="prose prose-slate text-sm space-y-4 text-slate-700 leading-relaxed">
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">6. AI Assistant (Jarvis)</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">7. Intellectual Property</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">8. Payment and Billing</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">9. Data Handling</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">10. Disclaimer of Warranties</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">11. Limitation of Liability</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">12. Indemnification</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">13. Termination</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">14. Governing Law</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">15. Changes to These Terms</h2>
        ...
        <h2 className="text-lg font-semibold text-slate-800 mt-8">16. Contact Us</h2>
