...
const FIELD_SYNONYMS: Record<string, string[]> = {
  ...
  company:            ["business", "organization", "organisation", "org", "company name", "companyname", "business name"],
  location:           ["city", "address", "region", "state", "area", "locale"],
  ...
  jobTitle:           ["title", "job title", "job_title", "position", "role", "designation"],
