              ...
              <>
                ...
                <div className="mt-4 pt-4 border-t border-slate-200 shrink-0">
                  <Button
                    ...
                    className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold h-12 rounded-xl text-lg gap-2"
                  >
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full h-11 px-4 rounded-xl border border-slate-200 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20 transition-all font-medium text-sm text-slate-800"
                  />
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className={`text-sm font-bold ${visibility === "organization" ? "text-indigo-700" : "text-slate-700"}`}>Entire Organization</p>
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className={`text-sm font-bold ${visibility === "specific" ? "text-indigo-700" : "text-slate-700"}`}>Specific People</p>
                  ...
                  <div className="pt-2">
                    ...
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 h-10 px-3 rounded-xl border border-slate-200 outline-none focus:border-indigo-500 text-sm font-medium text-slate-800"
                      />
                      <Button onClick={handleAddEmail} size="sm" className="h-10 px-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl">
                    ...
                    {invitedEmails.length > 0 && (
                      <div className="mt-3 flex flex-wrap gap-2">
                        {invitedEmails.map(email => (
                          <span key={email} className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-indigo-50 border border-indigo-100 text-indigo-700 rounded-full text-xs font-bold">
                            {email}
                ...
                <div className="pt-4 border-t border-slate-100 flex gap-3">
                  ...
                  <Button onClick={handleSave} disabled={isLoading} className="flex-1 h-11 rounded-xl bg-emerald-500 hover:bg-emerald-600 text-white font-bold gap-2">
