...
/** 
 * Get the Firestore collection path for CRM data.
 * Currently per-user. Once Firestore rules are updated to allow
 * shared/crm/* access, this will switch to org-level sharing.
 */
